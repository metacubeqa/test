...
public class Interruptions extends ReportBase {
	...
	public void beforeClass() {
		...
		hoverCheckList.add("Agent Overtalk Percentage");
	}
	
	//Verify default filter on Interruptions Report. 
	@Test(groups = { "Regression"})
	public void verify_default_filer_for_interruptions(){
		System.out.println("Test case --verify_default_filer_for_interruptions-- started ");
		...
		System.out.println("Test case --verify_default_filer_for_interruptions-- passed ");
	}
	
	//Verify Call Context filter for Interruptions Report. 
	@Test(groups = { "Regression"})
	public void verify_call_context_filter_for_interruptions(){
		System.out.println("Test case --verify_call_context_filter_for_interruptions-- started ");
		...
		caiReportPage.verifyReportImageDifferentAfterFilter(supportDriver, FilterType.CallContext, ReportsType.Interruptions);
		supportDriver.switchTo().defaultContent();
	
		driverUsed.put("supportDriver", false);
		System.out.println("Test case --verify_call_context_filter_for_interruptions-- passed ");
	}
	
//	Verify Management Level Filter for Interruptions report. 2915060
	@Test(groups = { "Regression"})
	public void verify_management_filter_for_interruptions(){
		System.out.println("Test case --verify_management_filter_for_interruptions-- started ");
		...
		caiReportPage.verifyReportImageDifferentAfterFilter(supportDriver, FilterType.ManagementLevel, ReportsType.Interruptions);

		driverUsed.put("supportDriver", false);
		System.out.println("Test case --verify_management_filter_for_interruptions-- passed ");
	}

	//Verify Username filter for Interruptions Report. 2915056
	@Test(groups = { "Regression" })
	public void verify_username_filter_for_interruptions() {
		System.out.println("Test case --verify_username_filter_for_interruptions-- started ");
		...
		caiReportPage.switchToReportFrame(supportDriver);
		caiReportPage.verifyInterruptionsAgentLevelFilter(supportDriver, reportDuration.Annual);

		driverUsed.put("supportDriver", false);
		System.out.println("Test case --verify_username_filter_for_interruptions-- passed ");
	}
	
	//Verify Team Name Filter for Interruptions Report.
	@Test(groups = { "Regression" })
	public void verify_teamname_filter_for_interruptions() {
		System.out.println("Test case --verify_teamname_filter_for_interruptions-- started ");
		...
		caiReportPage.switchToReportFrame(supportDriver);
		caiReportPage.verifyInterruptionsDataTeamLevelFilter(supportDriver);
		caiReportPage.verifySingularBarsData(supportDriver, ReportsType.Interruptions, caiReportPage.getTeamAgentsListToVerify(), hoverCheckList);

		driverUsed.put("supportDriver", false);
		System.out.println("Test case --verify_teamname_filter_for_interruptions-- passed ");
	}
	
	//Verify Location Filter for Interruptions Report.
	@Test(groups = { "Regression" })
	public void verify_location_filter_for_interruptions() {
		System.out.println("Test case --verify_location_filter_for_interruptions-- started ");
		...
		caiReportPage.switchToReportFrame(supportDriver);
		caiReportPage.verifyInterruptionsDataTeamLevelFilter(supportDriver);
		caiReportPage.verifySingularBarsData(supportDriver, ReportsType.Interruptions, caiReportPage.getLocationAgentsListToVerify(), hoverCheckList);

		driverUsed.put("supportDriver", false);
		System.out.println("Test case --verify_location_filter_for_interruptions-- passed ");
	}
	
//	Verify access filter for Interruptions Report for support user role.
	@Test(groups = { "Regression"})
	public void verify_access_filter_with_support_role_for_interruptions() {
		System.out.println("Test case --verify_access_filter_with_support_role_for_interruptions-- started ");
		...
		caiReportPage.verifyInterruptionsData(webSupportDriver);
		...
		System.out.println("Test case --verify_access_filter_with_support_role_for_interruptions-- passed ");
	}
	
	//Verify Interruptions Report with Account Name which is not exists
	@Test(groups = { "Regression"})
	public void verify_invalid_account_name_not_exists_for_interruptions() {
		System.out.println("Test case --verify_invalid_account_name_not_exists_for_interruptions-- started ");
		...
		driverUsed.put("webSupportDriver", false);
		System.out.println("Test case --verify_invalid_account_name_not_exists_for_interruptions-- passed ");
	}
	
	//Verify Interruptions Report with User Name which does not exist in selected/logged in account
	@Test(groups = { "Regression" })
	public void verify_username_not_exists_for_selected_account_interruptions() {
		System.out.println("Test case --verify_username_not_exists_for_selected_account_interruptions-- started ");
		...
		driverUsed.put("webSupportDriver", false);
		System.out.println("Test case --verify_username_not_exists_for_selected_account_interruptions-- passed ");
	}
	
	//Verify Interruptions Report with Location name which does not exist in selected/logged in account
	@Test(groups = { "Regression" })
	public void verify_location_not_exists_for_selected_account_interruptions() {
		System.out.println("Test case --verify_location_not_exists_for_selected_account_interruptions-- started ");
		...
		driverUsed.put("webSupportDriver", false);
		System.out.println("Test case --verify_location_not_exists_for_selected_account_interruptions-- passed ");
	}
	
	//Verify Interruptions Report with Team name which does not exist in selected/logged in account
	@Test(groups = { "Regression" })
	public void verify_teamname_not_exists_for_selected_account_interruptions() {
		System.out.println("Test case --verify_teamname_not_exists_for_selected_account_interruptions-- started ");
		...
		driverUsed.put("webSupportDriver", false);
		System.out.println("Test case --verify_teamname_not_exists_for_selected_account_interruptions-- passed ");
	}
}
