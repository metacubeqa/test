...
public class Interactions extends ReportBase {
	...
	public void beforeClass() {
		...
		hoverCheckList.add("Transitions per Minute");
	}
	
//	Verify default filter on Interaction report. 
	@Test(groups = { "Regression"})
	public void verify_default_filer_for_interactions(){
		System.out.println("Test case --verify_default_filer_for_interactions-- started ");
		...
		System.out.println("Test case --verify_default_filer_for_interactions-- passed ");
	}
	
//	Verify Call Context filter for Interactions Report.
	@Test(groups = { "Regression"})
	public void verify_call_context_filter_for_interactions(){
		System.out.println("Test case --verify_call_context_filter_for_interactions-- started ");
		...
		caiReportPage.verifyReportImageDifferentAfterFilter(supportDriver, FilterType.CallContext, ReportsType.Interactions);
		supportDriver.switchTo().defaultContent();
		
		driverUsed.put("supportDriver", false);
		System.out.println("Test case --verify_call_context_filter_for_interactions-- passed ");
	}
	
//	Verify Management Level Filter for Interactions Report. 
	@Test(groups = { "Regression"})
	public void verify_management_filter_for_interactions(){
		System.out.println("Test case --verify_management_filter_for_interactions-- started ");
		...
		caiReportPage.verifyReportImageDifferentAfterFilter(supportDriver, FilterType.ManagementLevel, ReportsType.Interactions);
		
		driverUsed.put("supportDriver", false);
		System.out.println("Test case --verify_management_filter_for_interactions-- passed ");
	}

	//Verify Username filter for Interactions Report.
	@Test(groups = { "Regression" })
	public void verify_username_filter_for_interactions() {
		System.out.println("Test case --verify_username_filter_for_interactions-- started ");
		...
		caiReportPage.switchToReportFrame(supportDriver);
		caiReportPage.verifyInteractionsAgentLevelFilter(supportDriver, reportDuration.Annual);

		driverUsed.put("supportDriver", false);
		System.out.println("Test case --verify_username_filter_for_interactions-- passed ");
	}
	
	//Verify Team Name Filter for Interactions Report.
	@Test(groups = { "Regression" })
	public void verify_teamname_filter_for_interactions() {
		System.out.println("Test case --verify_teamname_filter_for_interactions-- started ");
		...
		caiReportPage.switchToReportFrame(supportDriver);
		caiReportPage.verifyInteractionsDataTeamLevelFilter(supportDriver);
		caiReportPage.verifySingularBarsData(supportDriver, ReportsType.Interactions, caiReportPage.getTeamAgentsListToVerify(), hoverCheckList);

		driverUsed.put("supportDriver", false);
		System.out.println("Test case --verify_teamname_filter_for_interactions-- passed ");
	}
	
	//Verify Location Filter for Interactions Report.
	@Test(groups = { "Regression" })
	public void verify_location_filter_for_interactions() {
		System.out.println("Test case --verify_location_filter_for_interactions-- started ");
		...
		caiReportPage.switchToReportFrame(supportDriver);
		caiReportPage.verifyInteractionsDataTeamLevelFilter(supportDriver);
		caiReportPage.verifySingularBarsData(supportDriver, ReportsType.Interactions, caiReportPage.getLocationAgentsListToVerify(), hoverCheckList);

		driverUsed.put("supportDriver", false);
		System.out.println("Test case --verify_location_filter_for_interactions-- passed ");
	}
	
//	Verify access filter for Interactions Report for Support user role.
	@Test(groups = { "Regression"})
	public void verify_access_filter_with_support_role_for_interactions() {
		System.out.println("Test case --verify_access_filter_with_support_role_for_interactions-- started ");
		...
		caiReportPage.navigateToInteractions(webSupportDriver);
		...
		caiReportPage.verifyInteractionsData(webSupportDriver);
		...
		System.out.println("Test case --verify_access_filter_with_support_role_for_interactions-- passed ");
	}
	
	//Verify Interactions Report with Account Name which is not exists
	@Test(groups = { "Regression"})
	public void verify_invalid_account_name_not_exists_for_interactions() {
		System.out.println("Test case --verify_invalid_account_name_not_exists_for_interactions-- started ");
		...
		driverUsed.put("webSupportDriver", false);
		System.out.println("Test case --verify_invalid_account_name_not_exists_for_interactions-- passed ");
	}
	
	//Verify Interactions Report with User Name which does not exist in selected/logged in account
	@Test(groups = { "Regression" })
	public void verify_username_not_exists_for_selected_account_interactions() {
		System.out.println("Test case --verify_username_not_exists_for_selected_account_interactions-- started ");
		...
		driverUsed.put("webSupportDriver", false);
		System.out.println("Test case --verify_username_not_exists_for_selected_account_interactions-- passed ");
	}
	
	//Verify Interactions Report with Location name which does not exist in selected/logged in account
	@Test(groups = { "Regression" })
	public void verify_location_not_exists_for_selected_account_interactions() {
		System.out.println("Test case --verify_location_not_exists_for_selected_account_interactions-- started ");
		...
		driverUsed.put("webSupportDriver", false);
		System.out.println("Test case --verify_location_not_exists_for_selected_account_interactions-- passed ");
	}
	
	//Verify Interactions Report with Team name which does not exist in selected/logged in account
	@Test(groups = { "Regression" })
	public void verify_teamname_not_exists_for_selected_account_interactions() {
		System.out.println("Test case --verify_teamname_not_exists_for_selected_account_interactions-- started ");
		...
		driverUsed.put("webSupportDriver", false);
		System.out.println("Test case --verify_teamname_not_exists_for_selected_account_interactions-- passed ");
	}
}
