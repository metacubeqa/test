...
public class LocalPresence extends ReportBase{
	...
	public void beforeClass() {
		...
		hoverCheckList.add("lp_usage");
		hoverCheckList.add("% disposition_count");
	}
	
//	Verify Call Context filter on Local Presence Report. 2915141
	@Test(groups = { "Regression"})
	public void verify_call_context_filter_for_local_presence(){
		System.out.println("Test case --verify_call_context_filter_for_local_presence-- started ");
		...
		caiReportPage.verifyReportImageDifferentAfterFilter(supportDriver, FilterType.CallContext, ReportsType.LocalPresence);
		
		driverUsed.put("supportDriver", false);
		System.out.println("Test case --verify_call_context_filter_for_local_presence-- passed ");
	}
	
//	Verify Management Level filter on Local Presence Report. 2915142
	@Test(groups = { "Regression"})
	public void verify_management_filter_for_local_presence(){
		System.out.println("Test case --verify_management_filter_for_local_presence-- started ");
		...
		caiReportPage.verifyReportImageDifferentAfterFilter(supportDriver, FilterType.ManagementLevel, ReportsType.LocalPresence);
		
		driverUsed.put("supportDriver", false);
		System.out.println("Test case --verify_management_filter_for_local_presence-- passed ");
	}
	
	//Verify Teamname filter for Local Presence Report.
	@Test(groups = { "Regression" })
	public void verify_teamname_filter_for_local_presence() {
		System.out.println("Test case --verify_teamname_filter_for_local_presence-- started ");
		...
		// verifying data is loaded for Local Presence location
		caiReportPage.switchToReportFrame(supportDriver);
		caiReportPage.verifyLocalPresenceDataTeamLevelFilter(supportDriver);
		caiReportPage.verifyMultipleBarsData(supportDriver, ReportsType.LocalPresence, caiReportPage.getTeamAgentsListToVerify(), hoverCheckList);

		driverUsed.put("supportDriver", false);
		System.out.println("Test case --verify_teamname_filter_for_local_presence-- passed ");
	}
	
	//Verify Location Filter for Local Presence Report.
	@Test(groups = { "Regression" })
	public void verify_location_filter_for_local_presence() {
		System.out.println("Test case --verify_location_filter_for_local_presence-- started ");
		...
		caiReportPage.switchToReportFrame(supportDriver);
		caiReportPage.verifyLocalPresenceDataTeamLevelFilter(supportDriver);
		caiReportPage.verifyMultipleBarsData(supportDriver, ReportsType.LocalPresence, caiReportPage.getLocationAgentsListToVerify(), hoverCheckList);
		
		driverUsed.put("supportDriver", false);
		System.out.println("Test case --verify_location_filter_for_local_presence-- passed ");
	}
	
	//Verify access filter for Local Presence Report with support User role.
	@Test(groups = { "Regression"})
	public void verify_access_filter_with_support_role_for_local_presence() {
		System.out.println("Test case --verify_access_filter_with_support_role_for_local_presence-- started ");
		...
		caiReportPage.navigateToLocalPresence(webSupportDriver);
		...
		caiReportPage.verifyLocalPresenceData(webSupportDriver);
		...
		System.out.println("Test case --verify_access_filter_with_support_role_for_local_presence-- passed ");
	}
	
	//Verify LocalPresence Report with Account Name which is not exists
	@Test(groups = { "Regression"})
	public void verify_invalid_account_name_not_exists_for_local_presence() {
		System.out.println("Test case --verify_invalid_account_name_not_exists_for_local_presence-- started ");
		...
		driverUsed.put("webSupportDriver", false);
		System.out.println("Test case --verify_invalid_account_name_not_exists_for_local_presence-- passed ");
	}
	
	//Verify LocalPresence Report with User Name which does not exist in selected/logged in account
	@Test(groups = { "Regression" })
	public void verify_username_not_exists_for_selected_account_local_presence() {
		System.out.println("Test case --verify_username_not_exists_for_selected_account_local_presence-- started ");
		...
		driverUsed.put("webSupportDriver", false);
		System.out.println("Test case --verify_username_not_exists_for_selected_account_local_presence-- passed ");
	}
	
	//Verify LocalPresence Report with Location name which does not exist in selected/logged in account
	@Test(groups = { "Regression" })
	public void verify_location_not_exists_for_selected_account_local_presence() {
		System.out.println("Test case --verify_location_not_exists_for_selected_account_local_presence-- started ");
		...
		driverUsed.put("webSupportDriver", false);
		System.out.println("Test case --verify_location_not_exists_for_selected_account_local_presence-- passed ");
	}
	
	//Verify LocalPresence Report with Team name which does not exist in selected/logged in account
	@Test(groups = { "Regression" })
	public void verify_teamname_not_exists_for_selected_account_local_presence() {
		System.out.println("Test case --verify_teamname_not_exists_for_selected_account_local_presence-- started ");
		...
		driverUsed.put("webSupportDriver", false);
		System.out.println("Test case --verify_teamname_not_exists_for_selected_account_local_presence-- passed ");
	}
}
