...
public class Silence extends ReportBase {
	...
	public void beforeClass() {
		...
		hoverCheckList.add("Silence Percentage");
	}
	
//	Verify default filter on Silence report. 
	@Test(groups = { "Regression"})
	public void verify_default_filer_for_silence(){
		System.out.println("Test case --verify_default_filer_for_silence-- started ");
		...
		System.out.println("Test case --verify_default_filer_for_silence-- passed ");
	}
	
//	Verify Call Context filter for Silence Report. 
	@Test(groups = { "Regression"})
	public void verify_call_context_filter_for_silence(){
		System.out.println("Test case --verify_call_context_filter_for_silence-- started ");
		...
		caiReportPage.verifyReportImageDifferentAfterFilter(supportDriver, FilterType.CallContext, ReportsType.Silence);
			
		driverUsed.put("supportDriver", false);
		System.out.println("Test case --verify_call_context_filter_for_silence-- passed ");
	}
	
//	Verify Management Level Filter for Silence Report. 
	@Test(groups = { "Regression"})
	public void verify_management_filter_for_silence(){
		System.out.println("Test case --verify_management_filter_for_silence-- started ");
		...
		caiReportPage.verifyReportImageDifferentAfterFilter(supportDriver, FilterType.ManagementLevel, ReportsType.Silence);
	
		driverUsed.put("supportDriver", false);
		System.out.println("Test case --verify_management_filter_for_silence-- passed ");
	}

	//Verify Username filter for Silence Report.
	@Test(groups = { "Regression" })
	public void verify_username_filter_for_silence() {
		System.out.println("Test case --verify_username_filter_for_silence-- started ");
		...
		caiReportPage.switchToReportFrame(supportDriver);
		caiReportPage.verifySilenceAgentLevelFilter(supportDriver, reportDuration.Annual);

		driverUsed.put("supportDriver", false);
		System.out.println("Test case --verify_username_filter_for_silence-- passed ");
	}
	
	//Verify Team Name Filter for Silence Report.
	@Test(groups = { "Regression" })
	public void verify_teamname_filter_for_silence() {
		System.out.println("Test case --verify_teamname_filter_for_silence-- started ");
		...
		caiReportPage.switchToReportFrame(supportDriver);
		caiReportPage.verifySilenceDataTeamLevelFilter(supportDriver);
		caiReportPage.verifySingularBarsData(supportDriver, ReportsType.Silence, caiReportPage.getTeamAgentsListToVerify(), hoverCheckList);

		driverUsed.put("supportDriver", false);
		System.out.println("Test case --verify_teamname_filter_for_silence-- passed ");
	}
	
	//Verify Location Filter for Silence Report.
	@Test(groups = { "Regression" })
	public void verify_location_filter_for_silence() {
		System.out.println("Test case --verify_location_filter_for_silence-- started ");
		...
		caiReportPage.switchToReportFrame(supportDriver);
		caiReportPage.verifySilenceDataTeamLevelFilter(supportDriver);
		caiReportPage.verifySingularBarsData(supportDriver, ReportsType.Silence, caiReportPage.getLocationAgentsListToVerify(), hoverCheckList);

		driverUsed.put("supportDriver", false);
		System.out.println("Test case --verify_location_filter_for_silence-- passed ");
	}
	
//	Verify access filter for Silence Report for Support user role.
	@Test(groups = { "Regression"})
	public void verify_access_filter_with_support_role_for_silence() {
		System.out.println("Test case --verify_access_filter_with_support_role_for_silence-- started ");
		...
		caiReportPage.navigateToSilence(webSupportDriver);
		...
		caiReportPage.verifySilenceData(webSupportDriver);
		...
		System.out.println("Test case --verify_access_filter_with_support_role_for_silence-- passed ");
	}
	
	//Verify Silence Report with Account Name which is not exists
	@Test(groups = { "Regression"})
	public void verify_invalid_account_name_not_exists_for_silence() {
		System.out.println("Test case --verify_invalid_account_name_not_exists_for_silence-- started ");
		...
		driverUsed.put("webSupportDriver", false);
		System.out.println("Test case --verify_invalid_account_name_not_exists_for_silence-- passed ");
	}
	
	//Verify Silence Report with User Name which does not exist in selected/logged in account
	@Test(groups = { "Regression" })
	public void verify_username_not_exists_for_selected_account_silence() {
		System.out.println("Test case --verify_username_not_exists_for_selected_account_silence-- started ");
		...
		driverUsed.put("webSupportDriver", false);
		System.out.println("Test case --verify_username_not_exists_for_selected_account_silence-- passed ");
	}
	
	//Verify Silence Report with Location name which does not exist in selected/logged in account
	@Test(groups = { "Regression" })
	public void verify_location_not_exists_for_selected_account_silence() {
		System.out.println("Test case --verify_location_not_exists_for_selected_account_silence-- started ");
		...
		driverUsed.put("webSupportDriver", false);
		System.out.println("Test case --verify_location_not_exists_for_selected_account_silence-- passed ");
	}
	
	//Verify Silence Report with Team name which does not exist in selected/logged in account
	@Test(groups = { "Regression" })
	public void verify_teamname_not_exists_for_selected_account_silence() {
		System.out.println("Test case --verify_teamname_not_exists_for_selected_account_silence-- started ");
		...
		driverUsed.put("webSupportDriver", false);
		System.out.println("Test case --verify_teamname_not_exists_for_selected_account_silence-- passed ");
	}
}
