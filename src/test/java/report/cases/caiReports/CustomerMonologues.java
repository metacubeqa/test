...
public class CustomerMonologues extends ReportBase {
...
//	Verify default filter on Customer Monologues Report. 
	@Test(groups = { "Regression"})
	public void verify_default_filer_for_customer_monologues(){
		System.out.println("Test case --verify_default_filer_for_customer_monologues-- started ");
		...
		System.out.println("Test case --verify_default_filer_for_customer_monologues-- passed ");
	}
	
//	Verify Call Context filter for Customer Monologue Report. 
	@Test(groups = { "Regression"})
	public void verify_call_context_filter_for_customer_monologues(){
		System.out.println("Test case --verify_call_context_filter_for_customer_monologues-- started ");
		...
		caiReportPage.verifyReportImageDifferentAfterFilter(supportDriver, FilterType.CallContext, ReportsType.CustomerMono);
		
		driverUsed.put("supportDriver", false);
		System.out.println("Test case --verify_call_context_filter_for_customer_monologues-- passed ");
	}
	
//	Verify Management Level Filter for Customer monologue Report. 
	@Test(groups = { "Regression"})
	public void verify_management_filter_for_customer_monologues(){
		System.out.println("Test case --verify_management_filter_for_customer_monologues-- started ");
		...
		caiReportPage.verifyReportImageDifferentAfterFilter(supportDriver, FilterType.ManagementLevel, ReportsType.CustomerMono);
		
		driverUsed.put("supportDriver", false);
		System.out.println("Test case --verify_management_filter_for_customer_monologues-- passed ");
	}

	//Verify Username filter for Customer Monologue Report.
	@Test(groups = { "Regression" })
	public void verify_username_filter_for_customer_monologues() {
		System.out.println("Test case --verify_username_filter_for_customer_monologues-- started ");
		...
		caiReportPage.switchToReportFrame(supportDriver);
		caiReportPage.verifyCustomerMonologuesAgentLevelFilter(supportDriver, reportDuration.Annual);
	
		driverUsed.put("supportDriver", false);
		System.out.println("Test case --verify_username_filter_for_customer_monologues-- passed ");
	}
	
	//Verify Team Name Filter for Customer Monologue Report.
	@Test(groups = { "Regression" })
	public void verify_teamname_filter_for_customer_monologues() {
		System.out.println("Test case --verify_teamname_filter_for_customer_monologues-- started ");
		...
		caiReportPage.switchToReportFrame(supportDriver);
		caiReportPage.verifyCustomerMonologuesDataTeamLevelFilter(supportDriver);
		caiReportPage.verifyMultipleBarsData(supportDriver, ReportsType.CustomerMono, caiReportPage.getTeamAgentsListToVerify(), hoverCheckList);

		driverUsed.put("supportDriver", false);
		System.out.println("Test case --verify_teamname_filter_for_customer_monologues-- passed ");
	}
	
	//Verify Location Filter for Customer Monologue Report.
	@Test(groups = { "Regression" })
	public void verify_location_filter_for_customer_monologues() {
		System.out.println("Test case --verify_location_filter_for_customer_monologues-- started ");
		...
		caiReportPage.switchToReportFrame(supportDriver);
		caiReportPage.verifyCustomerMonologuesDataTeamLevelFilter(supportDriver);
		caiReportPage.verifyMultipleBarsData(supportDriver, ReportsType.CustomerMono, caiReportPage.getLocationAgentsListToVerify(), hoverCheckList);

		driverUsed.put("supportDriver", false);
		System.out.println("Test case --verify_location_filter_for_customer_monologues-- passed ");
	}
	
//	Verify access filter for Customer Monologues Report for Support user role.
	@Test(groups = { "Regression"})
	public void verify_access_filter_with_support_role_for_customer_monologues() {
		System.out.println("Test case --verify_access_filter_with_support_role_for_customer_monologues-- started ");
		...
		caiReportPage.verifyCustomerMonologuesData(webSupportDriver);
		...
		System.out.println("Test case --verify_access_filter_with_support_role_for_customer_monologues-- passed ");
	}
	
	//Verify Customer Monologues Report with Account Name which is not exists
	@Test(groups = { "Regression"})
	public void verify_invalid_account_name_not_exists_for_customer_monologues() {
		System.out.println("Test case --verify_invalid_account_name_not_exists_for_customer_monologues-- started ");
		...
		driverUsed.put("webSupportDriver", false);
		System.out.println("Test case --verify_invalid_account_name_not_exists_for_customer_monologues-- passed ");
	}
	
	//Verify Customer Monologues Report with User Name which does not exist in selected/logged in account
	@Test(groups = { "Regression" })
	public void verify_username_not_exists_for_selected_account_customer_monologues() {
		System.out.println("Test case --verify_username_not_exists_for_selected_account_customer_monologues-- started ");
		...
		driverUsed.put("webSupportDriver", false);
		System.out.println("Test case --verify_username_not_exists_for_selected_account_customer_monologues-- passed ");
	}
	
	//Verify Customer Monologues Report with Location name which does not exist in selected/logged in account
	@Test(groups = { "Regression" })
	public void verify_location_not_exists_for_selected_account_customer_monologues() {
		System.out.println("Test case --verify_location_not_exists_for_selected_account_customer_monologues-- started ");
		...
		driverUsed.put("webSupportDriver", false);
		System.out.println("Test case --verify_location_not_exists_for_selected_account_customer_monologues-- passed ");
	}
	
	//Verify Customer Monologues Report with Team name which does not exist in selected/logged in account
	@Test(groups = { "Regression" })
	public void verify_teamname_not_exists_for_selected_account_customer_monologues() {
		System.out.println("Test case --verify_teamname_not_exists_for_selected_account_customer_monologues-- started ");
		...
		driverUsed.put("webSupportDriver", false);
		System.out.println("Test case --verify_teamname_not_exists_for_selected_account_customer_monologues-- passed ");
	}
