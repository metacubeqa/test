...
public class UserBusyPresenceByDayNegCases extends ReportBase {
	...
	public void verify_user_busy_summary_by_day_with_invalid_team_name_filter() {
		System.out.println("Test case --verify_user_busy_summary_by_day_with_invalid_team_name_filter-- started ");
		...
		System.out.println("Test case --verify_user_busy_summary_by_day_with_invalid_team_name_filter-- passed ");
	}
	
	@Test(groups = { "Regression" })
	public void verify_user_busy_summary_by_day_with_invalid_location_name_filter() {
		System.out.println("Test case --verify_user_busy_summary_by_day_with_invalid_location_name_filter-- started ");
		...
		driverUsed.put("supportDriver", false);
		System.out.println("Test case --verify_user_busy_summary_by_day_with_invalid_location_name_filter-- passed ");
	}
	
	//@Test(groups = { "Regression" })
	public void verify_user_busy_summary_by_day_by_wrong_date_filter() {
		System.out.println("Test case --verify_user_busy_summary_by_day_by_wrong_date_filter-- started ");
		...
		driverUsed.put("supportDriver", false);
		System.out.println("Test case --verify_user_busy_summary_by_day_by_wrong_date_filter-- passed ");
	}
	
	//@Test(groups = { "Regression" })
	public void verify_user_busy_summary_by_day_by_future_date_filter() {
		System.out.println("Test case --verify_user_busy_summary_by_day_by_future_date_filter-- started ");
		...
		driverUsed.put("supportDriver", false);
		System.out.println("Test case --verify_user_busy_summary_by_day_by_future_date_filter-- passed ");
	}
	
	@Test(groups = { "Regression", "SupportOnly" })
	public void verify_user_busy_summary_by_day_with_invalid_accountName_filter() {
		System.out.println("Test case --verify_user_busy_summary_by_day_with_invalid_accountName_filter-- started ");
		...
		driverUsed.put("supportDriver", false);
		System.out.println("Test case --verify_user_busy_summary_by_day_with_invalid_accountName_filter-- passed ");
	}
	
	@Test(groups = { "Regression" })
	public void verify_user_busy_summary_by_day_with_invalid_agent_name_filter() {
		System.out.println("Test case --verify_user_busy_summary_by_day_with_invalid_agent_name_filter-- started ");
		...
		driverUsed.put("supportDriver", false);
		System.out.println("Test case --verify_user_busy_summary_by_day_with_invalid_agent_name_filter-- passed ");
	}
}
