...
public class AvgCallDuartionTabularNegCases extends ReportBase {
	...
	public void verify_avg_call_duration_tabular_by_wrong_date_filter() {
		System.out.println("Test case --verify_avg_call_duration_tabular_by_wrong_date_filter-- started ");
		...
		System.out.println("Test case --verify_avg_call_duration_tabular_by_wrong_date_filter-- passed ");
	}

	@Test(groups = { "Regression" })
	public void verify_avg_call_duration_tabular_by_future_date_filter() {
		System.out.println("Test case --verify_avg_call_duration_tabular_by_future_date_filter-- started ");
		...
		driverUsed.put("supportDriver", false);
		System.out.println("Test case --verify_avg_call_duration_tabular_by_future_date_filter-- passed ");
	}

	@Test(groups = { "Regression", "SupportOnly" })
	public void verify_avg_call_duration_tabular_with_invalid_accountName_filter() {
		System.out.println("Test case --verify_support_user_able_to_access_avg_call_tabular_duration_with_invalid_accountName_filter-- started ");
		...
		driverUsed.put("supportDriver", false);
		System.out.println("Test case --verify_avg_call_duration_tabular_with_invalid_accountName_filter-- passed ");
	}
}
